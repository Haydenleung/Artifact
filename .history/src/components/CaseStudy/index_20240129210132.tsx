            ...
            <div className={`${styles.research} ${styles.section}`}>
                ...
                <div className={`${styles.subGrid}`}>
                    ...
                    <div className={`${styles.subBody}`}>
                        <h4>User Survey</h4>
                        <p>This user survey aimed to gather insights from young students through a survey consisting of 30 questions. To ensure a representative sample, we delivered the study to multiple communities with a high concentration of young students. We ensured the survey was accessible to all participants and provided clear instructions.
                            <br /><br />
                            After the survey period ended, we received 11 responses from the communities. We then analyzed the responses and identified trends and patterns in the data. The insights we gained from the survey are helping us to understand better the needs, preferences, and challenges of young students.
                        </p>
                    </div>
                </div>
                <div className={`${styles.subGrid}`}>
