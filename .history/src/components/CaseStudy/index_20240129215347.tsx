                    ...
                    <div className={styles.subPersona}>
                        <div>
                            <p><span style={{ fontWeight: '700', fontSize: '12pt', lineHeight: '250%' }}>Primary <br /></span>
                                Liza Chow is a 20-year-old woman from Kitsilano, BC, pursuing a Bachelor of Fine Arts while working part-time. She strives to balance her studies, work, and personal life. Liza prioritizes personal growth and artistic improvement over saving money, but she aims to pay off her loans quickly for financial independence. <span style={{ fontWeight: '800' }}>She values security, stability, and communication and is seeking tools to manage her finances efficiently. Liza also wants to stay organized while combating creative limitations and impulsive spending tendencies.</span>
                            </p>
