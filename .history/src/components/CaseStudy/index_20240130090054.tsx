...
import timeline from "../../../public/image/moneyment/timeline.svg"
    ...
    return (
        <div className={styles.project}>
            ...
            <div className={`${styles.process} ${styles.section}`}>
                <div className={`${styles.processTitle} ${styles.heading}`}>Project Timeline</div>
                <Image src={timeline} alt="" width={100} height={400} className={styles.timelineImage} />
            </div>
            ...
            <div className={`${styles.design} ${styles.section}`}>
                <div className={`${styles.designTitle} ${styles.heading}`}>Design Decisions / Phase 1</div>
            ...
            <div className={`${styles.design} ${styles.section}`}>
                <div className={`${styles.designTitle} ${styles.heading}`}>Design Decisions / Phase 2</div>
                <div className={`${styles.designBody} ${styles.body}`}>
                    The new design approach focuses on scanning receipts and automating the categorization of daily spending. It implements a scanning API to read the content from the receipt and directly categorize it into a specific budget. This approach aims to help students monitor all their spending and not miss any. With the help of AI, the user's spending habits and behavior can be learned and analyzed, and the AI assistant can provide personalized suggestions to enhance their financial experience. The engagement approach has transitioned to a more controllable approach, and a new branding has been created.
                </div>
                <div className={`${styles.subGrid}`}>
