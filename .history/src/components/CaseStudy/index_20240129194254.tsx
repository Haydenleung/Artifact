...
export default function CaseStudy() {
    ...
    return (
        <div className={styles.project}>
            ...
            <ParallaxBanner style={{ aspectRatio: '1 / 1', width: '100%' }} className={styles.coverContainer}>
                <ParallaxBannerLayer image={banner.src} expanded={true} speed={-30} className={styles.projectCover} style={{ aspectRatio: '2 / 1', width: '100%', objectFit: 'cover', height: 'auto' }} />
            </ParallaxBanner>
