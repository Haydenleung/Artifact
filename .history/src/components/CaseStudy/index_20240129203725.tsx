    ...
    return (
        <div className={styles.project}>
            ...
            <div className={`${styles.problem} ${styles.section}`}>
                ...
                <div className={`${styles.problemBody} ${styles.body}`}>Financial stress is a significant problem in Canada. 1/3 of Canadians struggle to meet their financial needs, and certain disadvantaged groups, including 57% of young Canadians, are especially affected. This can lead to mental and physical health issues and decreased productivity. Addressing this issue requires financial education, access to affordable credit, and support for disadvantaged groups.</div>
