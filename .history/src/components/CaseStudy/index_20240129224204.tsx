        ...
        <div className={styles.project}>
            ...
            <div className={`${styles.design} ${styles.section}`}>
                ...
                <div className={`${styles.subGrid}`}>
                    <div className={`${styles.subBody}`}>
                        <h4>Color Palette</h4>
                        <p>The previous logo for pitching used the letter M in bright orange. Although the M had a unique typeface, it failed to convey the stability and financial aspect of the brand. The new logo design takes a different approach by showcasing financial growth through a bar chart. A single seed represents budgeting and saving. The new main color is a green gradient, symbolizing the safety of one's money.</p>
                    </div>
                    <Image src="/" alt="" width={100} height={400} className={styles.problemImage} />
                </div>
