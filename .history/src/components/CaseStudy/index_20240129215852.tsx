            ...
            <div className={`${styles.research} ${styles.section}`}>
                ...
                <div className={`${styles.subSection}`}>
                    ...
                    <div className={styles.subPersona}>
                        ...
                        <div>
                            <p><span style={{ fontWeight: '700', fontSize: '12pt', lineHeight: '250%' }}>Secondary <br /></span>
                                Omar Ali is a 28-year-old Syrian residing in East Vancouver. He is enrolled in the Auto Tech Apprentice program at Vancouver Community College while working full-time as a line cook. His ultimate goal is to become a Permanent Resident of Canada. However, he faces challenges in managing his finances efficiently, dealing with international fees, understanding budgeting, and navigating immigration paperwork. <span style={{ fontWeight: '600' }}></span>Omar is seeking practical tools to help him budget better, manage finances comprehensively, and ensure security and credibility in his decision-making for future endeavours.</span>
                            </p>
