...
export default function CaseStudy() {
    ...
    return (
        <div className={styles.project}>
            ...
            <ParallaxBanner style={{ aspectRatio: '1 / 1', width: '100vw' }} className={styles.coverContainer}>
                <ParallaxBannerLayer image={banner.src} speed={-20} className={styles.projectCover} style={{ aspectRatio: '2 / 1', width: '100%', objectFit: 'contain', height: 'auto' }} />
            </ParallaxBanner>
