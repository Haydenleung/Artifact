    ...
    return (
        <div className={styles.project}>
            ...
            <div className={`${styles.introduction}`}>
                ...
                <div className={`${styles.introBody} ${styles.body}`}>The project started in September 2023 and ended in December 2023. The main objective of the project was to design a financial and budgeting application specifically for post-secondary students. The application was powered by Artificial Intelligence (AI) technology and aimed to provide personalized financial recommendations and strategies to help improve the financial well-being of students. The goal was to create a revolutionary financial empowerment app that would uplift the lives of students.</div>
            </div>
