        ...
        <div className={styles.project}>
            ...
            <div className={`${styles.problem} ${styles.section}`}>
                ...
                <div className={`${styles.problemBody} ${styles.body}`}>
                    <p>The financial stress among Canadians is a significant problem that affects many individuals and families. According to Statistics Canada (2022), one-third of Canadians struggle to meet their financial needs, and one-quarter of Canadians cannot cover an unexpected $500 expense. Furthermore, certain disadvantaged groups, including 57% of young Canadians, are especially struggling with their financial situation, indicating that this issue is affecting a broad range of Canadians.</p>
                    <p>
